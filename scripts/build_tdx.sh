...
cd $workspace_dir
bazel --output_base=target build -c opt --copt=-DSPDLOG_ACTIVE_LEVEL=SPDLOG_LEVEL_DEBUG --define tee_type=tdx //teeapps/...
rm -rf $target_dir/tdx
mkdir -p $target_dir/tdx
...
cp $workspace_dir/bazel-bin/teeapps/framework/main $target_dir/tdx/teeapps/.
