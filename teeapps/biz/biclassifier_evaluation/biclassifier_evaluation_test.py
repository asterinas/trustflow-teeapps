...
from teeapps.biz.biclassifier_evaluation.biclassifier_evaluation import (
    run_biclassifier_evaluation,
)
...
TEST_CONFIG_JSON = """
{
  "appType": "OP_BICLASSIFIER_EVALUATION",
  "params": {
    "@type": "type.googleapis.com/teeapps.params.BiClassifierEvalParams",
    "label_field_name": "y",
...
class UnitTests(unittest.TestCase):
    def test_biclassifier_evaluation(self):
        ...
        # run
        run_biclassifier_evaluation(TEST_CONFIG_JSON)
        # after
