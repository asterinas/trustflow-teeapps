...
TEST_OUTPUT_LABEL_TYPES = ["float64", "bool"]
    ...
    def test_bin_class_predict(self):
        TEST_CONFIG_JSON = """
        {
          ...
          "inputs": [
            ...
            {
              "data_path": "teeapps/biz/testdata/lgbm_bin_class.model"
            }
          ],
          "outputs": [
            {
    ...
    def test_reg_predict(self):
        TEST_CONFIG_JSON = """
        {
          ...
          "inputs": [
            ...
            {
              "data_path": "teeapps/biz/testdata/lgbm_reg.model"
            }
          ],
          "outputs": [
            {
