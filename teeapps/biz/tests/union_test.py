...
from teeapps.biz.union.union import run_union
...
class UnitTests(unittest.TestCase):
    def test_union(self):
        ...
        # run
        run_union(json.loads(TEST_CONFIG_JSON))
        # after
        ...
        absolute_path = os.path.abspath(TEST_OUTPUT_PATH)
        print("Absolute path:", absolute_path)

        self.assertListEqual(rows[0], TEST_OUTPUT_COLUMNS)
        self.assertEqual(len(rows), 1139)
        # check output schema
