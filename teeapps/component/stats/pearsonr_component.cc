...
#include "pearsonr_component.h"

namespace teeapps {
namespace component {

void PearsonrComponent::Init() {
  AddIo(IoType::INPUT, "input_data", "Input table.",
        {DistDataType::INDIVIDUAL_TABLE},
        std::vector<TableColParam>{TableColParam(
            "feature_selects",
            "Specify which features to calculate correlation coefficient with. "
            "If empty, all features will be used")});
