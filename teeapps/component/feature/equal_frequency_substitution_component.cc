...
#include "equal_frequency_substitution_component.h"

namespace teeapps {
namespace component {

void EqualFrequencySubstitutionComponent::Init() {
  AddIo(IoType::INPUT, "input_data", "Dataset to be substituted.",
        {DistDataType::INDIVIDUAL_TABLE});
  AddIo(IoType::INPUT, "equal_frequency_binning_rule",
        "Equal frequency binning rule.",
