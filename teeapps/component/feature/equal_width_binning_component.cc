...
#include "equal_width_binning_component.h"

namespace teeapps {
namespace component {

void EqualWidthBinningComponent::Init() {
  ...
  AddIo(IoType::OUTPUT, "equal_width_binning_rule",
        "Output equal width binning rule.",
        {DistDataType::EQUAL_WIDTH_BINNING_RULE});
  AddIo(IoType::OUTPUT, "report", "Equal width binning report.",
        {DistDataType::REPORT});
}
